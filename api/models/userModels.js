...
const getUsers = (result) => {
    db.query("SELECT userID, firstName, lastName, userRole, emailAdd, userPass, userProfile FROM Users", (err, results) => {             
        if(err) {
            console.log(err);
            result(err, null);
        } else {
...
const getUserByID = (id, result) => {
    db.query("SELECT firstName, lastName, userRole, emailAdd, userPass, userProfile FROM Users WHERE userID = ?", [id], (err, results) => {             
        if(err) {
            console.log(err);
            result(err, null);
        } else {
