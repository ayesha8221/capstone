...
<div>
  ...
  <div class="column1">
    <!-- <img src="https://i.postimg.cc/mrJB3nqC/istockphoto-1168964829-612x612.jpg" alt="Forest"  class="beans"> -->
...
.cont .content {
  ...
  color: #E4C2A2; 
  width: 100%;
  -webkit-text-stroke: 1.5px #462507;
}
...
h4 {
  ...
  font-size: 50px;
  color: #E4C2A2;
  -webkit-text-stroke: 1.6px #462507;
  padding-bottom: 50px;
}
